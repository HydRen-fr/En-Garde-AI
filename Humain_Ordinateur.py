...
class JeuEnGarde:
    ...
    def tour_ordi(self):
        ...
        actions_possibles = {**self.ordinateur.recup_coups_legaux_action(self, "deplacement"), **self.ordinateur.recup_coups_legaux_action(self, "attaque")}
